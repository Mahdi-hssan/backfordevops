...
public class CategorieProduitServiceImplMock {
	...
	public void testRetrieveAllCategorieProduits() {
		...
		assertEquals(list.size(), is.retrieveAllCategorieProduits().size());
	}
	...
	public void testAddCategorieProduit() {
		...
		CategorieProduit catP = is.addCategorieProduit(cat);
		assertNotNull(catP);
	...
	public void testUpdateCategorieProduit() {
		...
		cat.setLibelleCategorie("LibelleUpdated");
		CategorieProduit catUpdated = is.updateCategorieProduit(cat);
